export default function Header() {
  return (
      <nav aria-label="mainNav" className="bg-white grid md:grid-cols-[10rem_auto_8rem] grid-cols-2 w-full md:px-24 px-6 py-4 border-b dark:border-white/5 border-black/5 shadow-lg text-themeColorDark">
