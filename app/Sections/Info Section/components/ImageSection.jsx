...
export default function ImageSection() {
    return (
        <div className="min-w-[20rem] flex-1 relative">
            <div className="h-[25rem] w-[calc(100%-2rem)] backdrop-blur-lg max-w-screen mx-auto overflow-hidden rounded-xl relative z-10 my-[1rem] grid place-items-center">
                <Image
                    src={"https://ablexerb.sirv.com/Images/aiony-haust-3TLl_97HNJo-unsplash.jpg"}
                    alt="Model"
                    height={1000}
                    width={1000}
                    className="absolute top-1/2 opacity-80 h-full min-w-full object-cover left-1/2 -translate-x-1/2 -translate-y-1/2"
                />
