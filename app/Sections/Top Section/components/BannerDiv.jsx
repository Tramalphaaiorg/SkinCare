export default function BannerDiv() {
    return (
        <section className="w-full justify-center items-center dark:bg-white/5 bg-opacity-20 bg-black/5 backdrop-blur-md mb-12">
            <div className="py-10 sm:px-32 px-2 bg-themeColor text-white flex flex-col items-center w-fit mx-auto gap-5">
                ...
                <div className="flex gap-3 sm:w-auto w-full justify-center">
