export default function TextSection() {
    return (
        <section className="flex-1 flex flex-col items-end sm:text-right text-center dark:text-white text-themeColorDark sm:pl-6">
            ...
            <div className="flex gap-3 items-center w-full sm:justify-end justify-center py-8">
